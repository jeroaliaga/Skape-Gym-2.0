...
<nav id="menu">
	...
	<main id='form'>
	<h2>Nueva Noticia</h2>
        <form action='new_notice.php' method='post' enctype='multipart/form-data'>
          <div>Título<input type='text'  name='Titulo' /></div>
          <div>Texto<textarea cols='50' rows='4' name='Texto'></textarea></div>
		  <div>Imagen<input type="file" name='Imagen' id='Imagen'></div>
       	  <div>Video<input type="text" name='Video'></div>
       	  <div>Fecha<input type="date" name='Fecha'></div>
